...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/TmcBundle/Entity')]), 'TmcBundle\\Entity');

$a->setEntityNamespaces(['TmcBundle' => 'TmcBundle\\Entity']);
