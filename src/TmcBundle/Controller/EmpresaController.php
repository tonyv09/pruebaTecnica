...
namespace TmcBundle\Controller;

use TmcBundle\Entity\Empresa;
...
class EmpresaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $empresas = $em->getRepository('TmcBundle:Empresa')->findAll();
    ...
    {
        $empresa = new Empresa();
        $form = $this->createForm('TmcBundle\Form\EmpresaType', $empresa);
    ...
    {
        $deleteForm = $this->createDeleteForm($empresa);
        $editForm = $this->createForm('TmcBundle\Form\EmpresaType', $empresa);
